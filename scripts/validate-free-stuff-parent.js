...
const expectedGeneratedFiles = 360 + expectedOpportunityCount * 2 + offerBaseline.generatedFileCount;
const expectedSitemapUrls = 100 + expectedOpportunityCount + offerBaseline.sitemapUrlCount;
