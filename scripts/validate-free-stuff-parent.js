...
check("Durable resources on parent", count(parent, /<article class="free-resource-card">/g), 27);
check("Durable resource schema items", resourceItemList?.itemListElement?.length || 0, 27);
check("Unverified Review Club resource excluded", parent.includes("https://reviewclub.co.za/how-it-works/"), false);
