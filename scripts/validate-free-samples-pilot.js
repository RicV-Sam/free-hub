...
const expectedGeneratedFiles = 341 + expectedOpportunityCount * 2 + offerBaseline.generatedFileCount;
const expectedSitemapUrls = 107 + expectedOpportunityCount + offerBaseline.sitemapUrlCount;
