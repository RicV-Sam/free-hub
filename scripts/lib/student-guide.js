...
function createStudentGuideRenderer({ escapeHtml: h, escapeAttribute: a, formatDate, renderAdBreak = () => "" }) {
  const link = (s) => `<a href="${a(s.url)}" rel="nofollow noopener">${h(s.label)}</a>`;
